...
public class PacienteView extends JFrame {
    ...
    public PacienteView(Paciente pacienteModi) {
        setTitle("✨ Modificacion de Paciente ✨");
        setSize(900, 700);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        // Actualizar casillas con los datos Registrados del paciente
        int idOriginal = pacienteModi.getId();
        String cedulaModi = pacienteModi.getCedula();
        String nombreModi = pacienteModi.getNombre();
        String apellidoModi = pacienteModi.getApellido();
        String edadModi = String.valueOf(pacienteModi.getEdad());
        String stringViviendaModi = pacienteModi.getVivienda().getTipo()+" - "+pacienteModi.getVivienda().getCiudad();
        
        addFormField(formPanel, "ID:", txtId = new JTextField(String.valueOf(idOriginal)), 10, labelFont, labelColor);
        addFormField(formPanel, "Cédula:", txtCedula = new JTextField(cedulaModi), 75, labelFont, labelColor);
        addFormField(formPanel, "Nombre:", txtNombre = new JTextField(nombreModi), 120, labelFont, labelColor);
        addFormField(formPanel, "Apellido:", txtApellido = new JTextField(apellidoModi), 170, labelFont, labelColor);
        addFormField(formPanel, "Edad:", txtEdad = new JTextField(edadModi), 220, labelFont, labelColor);
        addFormField(formPanel, "Vivienda:", txtVivienda = new JTextField(stringViviendaModi), 370, labelFont, labelColor);
        ...
        //Boton Registrar Vivienda
        JButton btnRegistrarVivienda = new JButton("Modificar");
        styleButton(btnRegistrarVivienda);
        btnRegistrarVivienda.setBounds(380, 370, 95, 35);
        ...
        // Botón de registro
        JButton btnRegistrar = new JButton("Modificar Paciente");
        styleButton(btnRegistrar);
        btnRegistrar.setBounds(100, 480, 280, 40);
        formPanel.add(btnRegistrar);
        ...
        btnRegistrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    pacienteModi.actualizarParametros(cedula, nombre, apellido, edad, tipoSangre, genero);
