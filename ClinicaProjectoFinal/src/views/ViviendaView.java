...
public class ViviendaView extends JFrame {
    ...
    public ViviendaView(ViviendaAddedListener listener, Vivienda viviendaModi) {
    	this.viviendaAddedListener = listener;
    	//Tomando Datos Vivienda Registrada
    	String direccionModi = viviendaModi.getDireccion();
    	String ciudadModi = viviendaModi.getCiudad();
    	String codigoPostalModi = viviendaModi.getCodigoPostal();
    	
    	
        setTitle(" Modificacion de Vivienda ");
        setSize(900, 700);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        // Título decorativo
        JLabel titleLabel = new JLabel("Sistema de Modificacion de Vivienda");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 24));
        titleLabel.setForeground(new Color(41, 84, 144));
        titleLabel.setBounds(50, 20, 400, 40);
        mainPanel.add(titleLabel);
        ...
        txtDireccion = new JTextField(direccionModi);
        styleTextField(txtDireccion);
        txtDireccion.setBounds(170, 40, 280, 35);
        ...
        txtCiudad = new JTextField(ciudadModi);
        styleTextField(txtCiudad);
        txtCiudad.setBounds(170, 120, 280, 35);
        ...
        txtCodigoPostal = new JTextField(codigoPostalModi);
        styleTextField(txtCodigoPostal);
        txtCodigoPostal.setBounds(170, 200, 280, 35);

        JButton btnRegistrar = new JButton(" Modificar Vivienda");
        styleButton(btnRegistrar);
        btnRegistrar.setBounds(100, 430, 280, 40);
        ...
        btnRegistrar.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent e) {
        		...
        		vivienda = new Vivienda(direccion, ciudad, tipo, codigoPostal);
        		JOptionPane.showMessageDialog(null, "✅ Vivienda Modificada exitosamente!", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        		//Pasar Vivienda a PacienteView
        		if (viviendaAddedListener != null) {
        			viviendaAddedListener.onViviendaAdded(vivienda);
        		}
